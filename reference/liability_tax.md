...
list, containing the following measures: \`income_net\` for the net
income (after Income Tax and National Insurance); \`income_tax\` for the
Income Tax liability; \`ni\` for the National Insurance liability; and
\`total_tax\` for the combined Income Tax and National Insurance
liability.
